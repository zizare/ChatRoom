...
public class AccueilClientIHM extends JPanel implements ActionListener, IChatter, KeyListener{
	public static void main(String[] args) {
		...
		try {
			...
			JPanel a=new AccueilClientIHM("gui",gt);
			f.setContentPane(a);
			f.setSize(800, 600);
	...
	AccueilClientIHM(String nom, ITopicManager gt)
	{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==ListTopicb){
			...
			cr.poster(textEcris.getText(), new TextChatter(nom));	
		}
